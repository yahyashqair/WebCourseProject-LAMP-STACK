...
function printForm1()
{
	...
	<form action="<?php $_SERVER['PHP_SELF']?>" method="POST">
		...
		<br>
		<br>
		<input type="submit" name="show" value="Display picnics" style="border-radius: 10px;font-size: 20px;">    
		<br />
	</form>
	<?php 
}
...
{
	$table = "<table border='1'><caption>Picnics Table</caption><thead><tr>";
