...
function field() {
	...
	$q = $pdo->prepare("DESCRIBE customer");
	$q->execute();
...
function printForm1()
{
	...
	<form action="<?php $_SERVER['PHP_SELF']?>" method="POST">
		...
		<br>
		<br>
		<input type="submit" name="show" value="Display customers" style="border-radius: 10px;font-size: 20px;">    
		<br />
	</form>
	<?php 
}
...
{
	$table = "<table border='1'><caption>Customers Table</caption><thead><tr>";
